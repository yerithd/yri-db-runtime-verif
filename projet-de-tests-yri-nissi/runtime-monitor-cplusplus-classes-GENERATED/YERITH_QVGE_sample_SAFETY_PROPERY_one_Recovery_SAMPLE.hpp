/*
* YERITH_QVGE_sample_SAFETY_PROPERY_one_Recovery_SAMPLE.hpp
*
*/
...
class YERITH_QVGE_sample_SAFETY_PROPERY_one_Recovery_SAMPLE : public YRI_DB_RUNTIME_VERIF_Monitor
{
    Q_OBJECT
...
public:
    ...
    YERITH_QVGE_sample_SAFETY_PROPERY_one_Recovery_SAMPLE(YRI_DB_RUNTIME_VERIF_Logger *logger);

    inline virtual ~YERITH_QVGE_sample_SAFETY_PROPERY_one_Recovery_SAMPLE()
    {
    }
...
#endif /* _YRI_DB_VERIF_RUNTIME_MONITOR_YERITH_QVGE_sample_SAFETY_PROPERY_one_Recovery_SAMPLE_HPP_ */
