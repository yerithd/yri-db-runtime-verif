...
do
    ...
    YRI_RUNTIME_MONITOR_INSTANTIATION_CODE="${YRI_RUNTIME_MONITOR_INSTANTIATION_CODE}user_defined_Runtime_Monitors.append(\&${YRI_RUNTIME_MONITOR_CLASS_INSTANCE_VARIABLE});\n\n"
done
