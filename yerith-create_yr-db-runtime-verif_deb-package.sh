...
#author: DR.-ING.  DR.-ING. DIPL.-INF. XAVIER NOUNDOU (YEROTH R&D)!
...
cp YRI-DB-RUNTIME-VERIF-GUI-ELEMENTS-SETUP/YEROTH_QVGE.pdf \
	yri-db-runtime-verif/usr/share/doc/yri-db-runtime-verif
...
cp yri.db-runtime.verif.xml ${YEROTH_ERP_3_0_HOME_FOLDER}/src/dbus/
